...
public class Solution {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedReader bufferedReader = new BufferedReader(new FileReader("PazlTestFiles/" + scanner.next() + ".txt"));
            ...
            Solution solution = new Solution(initial);
            if (!solution.isSolvable())
                System.out.println("Дошка не має розв'язку");
            else {
                System.out.println("Мінімальна кількість кроків = " + solution.moves());
                for (Board board : solution.solution())
