...
public class SeamCarverGUI {
	public int[][] colorArray;
	public final double D_INFINITY = Double.POSITIVE_INFINITY;
	
    public static void main(String[] args) {
        Picture myPicture = new Picture("HJoceanSmall.png");
        SeamCarverGUI seamC = new SeamCarverGUI(myPicture);
	...
	public SeamCarverGUI(Picture picture) {
		int w = picture.width();
