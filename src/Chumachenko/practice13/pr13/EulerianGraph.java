...
/**
 * Малює граф ейлера і гамільтона
 * Напишіть і реалізуйте EulerianGraph для графів,
 *  вершини яких подані у вигляді
 * точок на площині з вказаними координатами.
 *  Включіть метод show() для
...
public class EulerianGraph {
	...
	/**
	 * метод, що малює направлену стрілочку з номером кроку на шляху ейлера txt
	 * 
	 */
	private static void arrow(double x1, double y1, double x2, double y2, String txt) {
		double fi = Math.PI / 12; // кут нахилу стрілочки по відношеню до лінії
