...
public class Solver {
	private class SNode implements Comparable<SNode>
	{
		...
		public SNode(Board initial) // знайти рішення для дошки initial
		{
			board = initial;
			moves = 0;
			previous = null;
 ...
 // мінімальна кількість кроків для вирішення дошки, -1 якщо немає
    public int moves()                      
    {
    	return M;
    }
 ...
 // послідовність дошок в найкоротшому рішенні; null якщо 
    public Iterable<Board> solution()
    {
    	return solutions;
    }
    
    public static void main(String[] args) // вирішити
    {
